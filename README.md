...
系统核心目标是面向`长文本场景`，提供高效的语义一致性检测和中文语法纠错服务。  
并通过引入`Human-In-The-Loop`机制，实现对检测结果的人工偏好修正，调整模型输出策略。

- **法律文档审核**：自动检查法律文件中的语法错误和实体一致性
- **学术论文检查**：自动检查学术论文中的语法错误和实体一致性
- **专业文档自查**：自动检查客户服务记录中的语法错误和实体一致性
